...
def main():
    ...
    for B in B_list:
        ...
        np.save("./hartmann_imbalanced_loss_B_%d_T_%d_random"%(B, T), L_trials)
        np.save("./hartmann_imbalanced_error_B_%d_T_%d_random"%(B, T), error_list)
