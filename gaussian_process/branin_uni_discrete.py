...
def main():
    ...
    for B in B_list:
        ...
        for C in C_l:
            ...
            np.save("./branin_uniform_loss_B_%d_T_%d_C_%d_discrete"%(B, T, C*100), L_trials)
            np.save("./branin_uniform_error_B_%d_T_%d_C_%d_discrete"%(B, T, C*100), error_list)
